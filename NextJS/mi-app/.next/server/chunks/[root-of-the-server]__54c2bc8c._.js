...
const QUERIES = {
    ...
    /* ── AGRUPACIONES ── */ empleados_por_proyecto: {
    ...
    /* ── FILTROS ESPECIALES ── */ asignaciones_por_rango: {
...
async function GET(req) {
    ...
    /* sin id → catálogo */ if (!id) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(catalog);
    }
    const def = QUERIES[id];
    if (!def) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "Query no encontrada"
        }, {
            status: 404
        });
    }
    /* recoger params del querystring */ const userParams = {};
    ...
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].query(sql, values);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54c2bc8c._.js.map